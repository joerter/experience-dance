  ...
  base: [
    {
      ...
      style: ({ theme }) => ({
        ...
        [`& .${buttonClasses.loadingPositionStart}`]: { left: 14 },
        [`& .${buttonClasses.loadingPositionEnd}`]: { right: 14 },
        [`&.${buttonClasses.sizeSmall}`]: {
          [`& .${buttonClasses.loadingPositionStart}`]: { left: 10 },
          [`& .${buttonClasses.loadingPositionEnd}`]: { right: 10 },
        },
      }),
    },
  ],
